...
class ViewerBot:
    def print_exception(self):
        ...
        print(Colors.red + 'EXCEPTION IN ({}, LINE {} "{}"): {}'.format(filename, lineno, line.strip(), exc_obj))
    ...
    def get_proxies(self):
        ...
        try:
            ...
            print(Colors.red + "An error has occurred while trying to read the list of proxies: %s" % e.strerror)
            sys.exit(1)
    ...
    def get_url(self):
        ...
        try:
            ...
            try:
                ...
                print(Colors.green + f"URL : {url[:30]}...\n")
            except:
        ...
        try:
            ...
            try:
                 if time.time() - proxy_data['time'] >= random.randint(1, 5):
                    ...
                    print(Colors.green + f"Sent HEAD request with {current_proxy['http']} | {response.status_code} | {response.request} | {response}")
